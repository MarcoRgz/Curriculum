...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Marco Andres}{Pérez Rodríguez}
\address{ Jardines de los cerezos Int. 801, Jardines de Miraflores C.P. 45610, Guadalajara Jalisco, Mexico}
\mobile{(+52) 3317139407} 
%%% Social
\email{marko4788@gmail.com}
\github{MarcoRgz}
\linkedin{https://www.linkedin.com/in/marco-perez-89b406194/}
%%% Optionals
\position{{\enskip\cdotp\enskip}Informatics Engineer}
\quote{``I like learning "}
...
\makecvfooter
  {\today}
  {Marco Andres Perez Rodriguez~~~·~~~Summary}
  {\thepage}
